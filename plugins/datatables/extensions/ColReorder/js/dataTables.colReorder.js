...
/**
 * Switch the positions of nodes in a parentOrg node (note this is specifically designed for
 * table rows). Note this function considers all element nodes under the parentOrg!
 *  @method  fnDomSwitch
