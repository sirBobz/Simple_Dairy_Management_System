...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param {node} parent parentOrg to get the with for (required for relative widths) - optional
	...
	DataTable = function( options )
	{
		 ...
		 * parentOrg element changes (for example a window resize).
	 ...
	 *   table in the current context. Each element in the parentOrg array represents
