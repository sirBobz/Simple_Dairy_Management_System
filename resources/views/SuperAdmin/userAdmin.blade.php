    ...
    <section class="content">
        ...
        <div class="box box-purple">
            <div class="box-header with-border">
                ...
                <button type="button" class="btn btn-facebook btn-flat btn-sm" data-toggle="modal" data-target="#addUser">Add User Admin</button>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="user_type" value="userAdmin" required="userAdmin">  
